...
def misc():
    ...
    def credits():
        mb.showinfo("Copyright&Info",
                    ...
                    "work with whole names too.\n-Login via name is now possible\n-Privacy Center\n-More Details on Jobs\n-User access on App files\n-Changes to network check")
...
def mempage2():
    ...
    #    page = Button(frame, bg="#3d3d3d", image=backw, compound=TOP, command=memProfile)
    #   page.place(x=463, y=313, width=32, height=32)

    #    Friendbut = Button(frame, bg="#3d3d3d", image=pho, compound=TOP, command=logout)
    #   Friendbut.place(x=463, y=350, width=32, height=32)

    #    Friendbut1 = Button(frame, bg="#3d3d3d", image=guildicon, compound=TOP, command=guildmember)
    #   Friendbut1.place(x=426, y=350, width=32, height=32)
...
def startwindow():
    ...
    Label3 = customtkinter.CTkLabel(frame, text="Ver 4.0.0", width=50, height=20)
...
def eula():
    ...
    if checkvar == 1:
        ...
        my_label.insert(INSERT,
                        text="By using this software, you agree to the ways this application uses the data provided by you. More info under Settings->Privacy.\n\n"
